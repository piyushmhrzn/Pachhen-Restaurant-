...
window.onscroll = () => {
  ...
  const parallax1 = document.getElementById("pageHeader");
  ...
  if (
    ...
    const parallaxMenu = document.getElementById("eat-together");
    parallaxMenu.style.backgroundPositionY = `${scrollpos * -0.6 + 750}px`;
  }
  ...
  if (
    ...
    let scrollpos = window.pageYOffset;
    const parallaxKitchen = document.getElementById("the-kitchen");
    parallaxKitchen.style.backgroundPositionY = `${scrollpos * -0.6 + 1700}px`;
  }
};
